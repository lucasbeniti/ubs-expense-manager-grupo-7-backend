...
public class ExpensesMapper {
    public static ExpensesDto mapToExpensesDto(Expenses expenses){
        return new ExpensesDto(
                ...
                expenses.getStatus(),
                expenses.getAmount(),
                expenses.getFk_currency_id().getCurrency_id() != null ? expenses.getFk_currency_id().getCurrency_id() : null,
                expenses.getExchange_rate_snapshot(),
                expenses.getFk_employee_id().getEmployee_id() != null ? expenses.getFk_employee_id().getEmployee_id() : null,
                expenses.getFk_category_id().getCategory_id() != null ? expenses.getFk_category_id().getCategory_id() : null,
    ...
    public static Expenses mapToExpenses(ExpensesDto expensesDto){
        ...
        expenses.setStatus(expensesDto.getStatus());
